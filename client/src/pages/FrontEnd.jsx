              ...
              <div className="mt-20 md:grid grid-cols-5 gap-x-10 gap-y-10  m-auto">
                ...
                <div className="hidden md:block col-span-2">
                  <p className="text-white text-start tracking-wide font-theme-font">
                    Increase user engagement, reduce bounce rates, and boost
                    your conversion rates with Devox as your loyal front-end
                    development agency. Let us provide a meticulously crafted
                    and responsive design that will perform steadily across all
