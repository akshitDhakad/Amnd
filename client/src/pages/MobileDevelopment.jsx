...
export default function MobileDevelopmentPage() {
  ...
  const backgroundImg = {
    backgroundImage: `url('https://devoxsoftware.com/wp-content/uploads/2024/01/shubham-dhage-WzKi0E3ZFRc-unsplash.webp')`,
              ...
              <div className="mt-20 md:grid grid-cols-5 gap-x-10 gap-y-10  m-auto">
                ...
                <div className="hidden md:block col-span-2">
                  <p className="text-white text-start tracking-wide font-theme-font">
                    AMNDTECH Software provides mobile app development services,
                    both native and cross-platform. Drop us a line to get your
                    app in time and budget.
                  </p>
