              ...
              <div className="mt-20 md:grid grid-cols-5 gap-x-10 gap-y-10  m-auto">
                ...
                <div className="hidden md:block col-span-2">
                  <p className="text-white text-start tracking-wide font-theme-font">
                    Leverage database development services with Devox Software.
                    Streamline data management on your product’s back-end,
                    maintain its consistency with less operational efforts, and
                    enhance decision-making capabilities with our professionals’
                    expertise.
                  </p>
