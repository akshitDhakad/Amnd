  ...
  return (
    <div className="flex flex-col gap-y-10">
      ...
      <div className="w-full grid grid-cols-2 gap-x-2  md:grid-cols-8 gap-y-5">
        {/* item 1 */}
        <div className="h-32 2xl:h-48 md:w-32 2xl:w-48 p-2 rounded-3xl border-4 shadow-lg hover:cursor-pointer hover:shadow-md hover:shadow-purple-600 bg-slate-50">
          <img
            loading="lazy"
